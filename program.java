...
public class program {
    ...
    public static String getArtistInfo(String artistName) throws Exception {
        ...
        String urlString = "http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist="
                + artistName + "&api_key=" + API_KEY + "&format=json";
        ...
        // Extract the artist's biography (summary)
        int listeners = artist.getJSONObject("stats").getInt("listeners");

        return "Number of listeners: " + listeners;  // Return the artist's bio or any other data you'd like
    }
